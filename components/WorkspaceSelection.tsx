                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-8 bg-black/60 dark:bg-black/80 backdrop-blur-md transition-colors">
                    <div className="relative w-full max-w-lg bg-white dark:bg-[#16191f] border border-gray-200 dark:border-gray-800 rounded-[2.5rem] p-8 shadow-2xl animate-in zoom-in-95 transition-colors">
                        ...
                        <div className="space-y-4 mb-10">
                            ...
                            <div className="space-y-2"><label className="text-[10px] font-black text-gray-500 uppercase tracking-widest transition-colors">Domain</label><select value={newProjectForm.domain} onChange={e => setNewProjectForm({ ...newProjectForm, domain: e.target.value })} className="w-full bg-gray-50 dark:bg-[#0c0e12] border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-3 text-sm text-gray-700 dark:text-gray-400 outline-none transition-colors shadow-sm dark:shadow-none"><option value="Finance">Finance</option><option value="Shopping">Shopping</option><option value="Telecom">Telecom</option><option value="Other">Other</option></select></div>
